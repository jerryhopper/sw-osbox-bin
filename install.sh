...
PHP_INI_SCAN_DIR=/usr/local/osbox/bin/conf.d /usr/local/osbox/bin/osboxd -c /usr/local/osbox/bin/osboxd.ini --working-dir=/usr/local/osbox/project/sw-osbox-core /usr/local/osbox/bin/composer.phar install
